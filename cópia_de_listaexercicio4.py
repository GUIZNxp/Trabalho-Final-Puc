# -*- coding: utf-8 -*-
"""Cópia de ListaExercicio4.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EYHgEj_ozbgecbNQ-dWO1xjoVhq39D3G
...
ax.title('Margem Líquida e ROA por Ano')
ax.xlabel('Ano')
...
df_2 = pd.merge(df, df1[['Ano', 'IPCA']], on='Ano', how='left')
